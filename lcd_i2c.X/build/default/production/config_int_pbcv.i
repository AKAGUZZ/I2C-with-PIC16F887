...
# 9 "config_int_pbcv.c" 2

# 1 "./config_int_pbcv.h" 1
# 13 "./config_int_pbcv.h"
void cfginterrupciones(void);
void __attribute__((picinterrupt(("")))) interrpExt(void);
# 10 "config_int_pbcv.c" 2
...
# 11 "config_int_pbcv.c" 2

# 1 "./ds1307_control.h" 1
# 15 "./ds1307_control.h"
